...
with(data,plot(Time, as.numeric(Global_active_power), type="l", xlab="", ylab="Global Active Power"))
with(data,plot(Time, as.numeric(Voltage), type="l", xlab="datetime", ylab="Voltage"))
...
legend("topright", lty=1, col=c("black", "red", "blue"), legend=c("Sub_metereing_1","Sub_metereing_2","Sub_metering_3"), cex = 0.6)
with(data,plot(Time, as.numeric(Global_reactive_power), type="l", xlab="datetime", ylab="Global_reactive_power"))
dev.off()
